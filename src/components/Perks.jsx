              ...
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div className="flex flex-col">
                  ...
                  <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    ...
                    <p className="mt-6">
                      <a href="#" className="text-base font-semibold leading-7 text-red-500">See Shopper Jobs <span aria-hidden="true">→</span></a>
                    </p>
                  </dd>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    ...
                    <p className="mt-6">
                      <a href="#" className="text-base font-semibold leading-7 text-red-500">See Runner Jobs <span aria-hidden="true">→</span></a>
                    </p>
                  </dd>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    ...
                    <p className="mt-6">
                      <a href="#" className="text-base font-semibold leading-7 text-red-500">Learn more <span aria-hidden="true">→</span></a>
                    </p>
                  </dd>
                </div>
              </dl>
