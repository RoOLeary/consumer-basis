                      ...
                      <>
                        ...
                        >
                          ...
                          <div className="mt-8 flex flex-col gap-4">
                            <Button href="/login" variant="outline" className="rounded-md bg-red-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">
                              Log in
                            </Button>
