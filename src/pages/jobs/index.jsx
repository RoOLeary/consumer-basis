                      ...
                      <form className="hidden lg:block">
                        ...
                        <div className="border-b border-gray-200 py-6">
                          ...
                          <div className="pt-6" id="filter-section-0">
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center">
                                <input id="filter-color-2" name="color[]" value="blue" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500" />
                        ...
                        <div className="border-b border-gray-200 py-6">
                          ...
                          <div className="pt-6" id="filter-section-0">
                            <div className="space-y-4">
                              <div className="flex items-center">
                                <input id="filter-color-0" name="color[]" value="white" type="checkbox" defaultChecked className="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500" />
                        ...
                        <div className="border-b border-gray-200 py-6">
                          ...
                          <div className="pt-6" id="filter-section-1">
                            <div className="space-y-4">
                              <div className="flex items-center">
                                <input id="filter-category-0" name="category[]" value="nl" type="checkbox" defaultChecked className="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500" />
                                <label htmlFor="filter-category-0" className="ml-3 text-sm text-gray-600">The Netherlands</label>
                              </div>

                              <div className="flex items-center">
                                <input id="filter-category-1" name="category[]" value="fr" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500" />
                                <label htmlFor="filter-category-1" className="ml-3 text-sm text-gray-600">France</label>
                              </div>

                              <div className="flex items-center">
                                <input id="filter-category-2" name="category[]" value="de" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500" />
